    ...
    return (
        ...
        <h1 className="font-display text-2xl font-bold text-surface-900 dark:text-surface-50">Admin log in</h1>
        <p className="mt-2 text-sm text-surface-500 dark:text-surface-400">
            Access the platform's control panel.
        </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
            ...
            label="Email address"
            type="email"
            placeholder="admin@homerescueos.com"
